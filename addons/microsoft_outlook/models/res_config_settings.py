...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            microsoft_outlook_client_identifier=ICP.get_param("microsoft_outlook_client_id"),
    ...
    def set_values(self):
        ...
        ICP = self.env["ir.config_parameter"]
        ICP.set_param("microsoft_outlook_client_id", self.microsoft_outlook_client_identifier)
        ICP.set_param(
